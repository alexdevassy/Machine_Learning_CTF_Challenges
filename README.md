...
| --- | --- | --- | --- | --- | 
| [Matrix](/Matrix_AI_Agent_CTF_Challenge/) | Web - Insecure A2A Agent | Exploit Agent's capability to fetch Flag:{\<FLAG>} . | Medium | <ul><li>[OWASP ASI02:2026](https://genai.owasp.org/resource/owasp-top-10-for-agentic-applications-for-2026/)</li></ul>
